    ...
    return (  
       <div>
         ...
         <div style={{textAlign: "center",marginTop: "6rem"}}>
            <p className="maintext" style={{color: "#201f2f",fontWeight: "650",fontSize: "3.2rem",letterSpacing: "-1px"}}>Our Main Services</p>
         ...
         <div className="serva container d-flex justify-content-between">
           <div className="rectangle">
             ...
             <div style={{marginTop: "7rem"}} className="serv">
           ...
           <div className="serva d-flex mt-5">
             <div style={{marginTop: "7rem"}} className="servaitem">
           ...
           <div className="rectangle">
             ...
             <div className="serv" style={{marginTop: "7rem"}}>
               <p className="serv1" style={{color: "#201f2f",fontWeight: "650",fontSize: "3rem",lineHeight: "5rem",overflowWrap: "break-word",lineHeight: "3.2rem"}}>Website <br /> Development</p>
               <p className="serv2" style={{color: "#201f2f",fontWeight: "500",fontSize: "1rem",marginTop: "1rem",lineHeight: "2rem",lineHeight: "1.5rem",letterSpacing: "-1px",marginTop: "2.8rem"}}>Your website is the cornerstone of your online presence. At our <br />agency, we specialize in creating web masterpieces that stand out <br /> from the crowd. Our team of expert designers and developers will <br /> work closely with you to create a website that not only looks great <br /> but also performs at its best.</p>
               <p className="serv3" style={{color: "#201f2f",fontWeight: "500",fontSize: "1rem",marginTop: "1rem",lineHeight: "2rem",lineHeight: "1.5rem",letterSpacing: "-1px",marginTop: "2.8rem"}} >Let us help you bring your vision to life and create a web <br /> masterpieces that represents your brand in the best possible light.</p>
                <div className="btns">
                  <button className="blue-link" style={{backgroundColor: "#6E368C",color: "white",width: "10rem",height: "2.5rem",fontWeight: "400",fontSize: "1rem",borderStyle: "none",borderRadius: "3px",marginTop: "-1rem"}}>Learn More</button>
                </div>
             </div> 
