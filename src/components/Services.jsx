    ...
    return (  
       <div>
         ...
         <div className="serva container d-flex justify-content-between">
           ...
           <div className=" row serva container justify-content-between mt-5">
             <div style={{marginTop: "7rem",marginLeft: "-3rem"}} className="col" >
             ...
             <div className="rectangle-mid bg-dark" className>
